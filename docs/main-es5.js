        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LoginComponent = /** @class */ (function () {
                ...
                LoginComponent.prototype.login = function () {
                    var name = document.querySelectorAll(".input_user")[0].value;
                    var pass = document.querySelectorAll(".input_pass")[0].value;
                    this._user.login(name, pass);
                };
                LoginComponent.prototype.signIn = function () {
                    var name = document.querySelector("#defaultForm-email").value;
                    var pass = document.querySelector("#defaultForm-pass").value;
                    if (name != "" && pass != "") {
